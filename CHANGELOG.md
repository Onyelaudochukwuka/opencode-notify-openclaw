...
## [0.9.0](https://github.com/Onyelaudochukwuka/opencode-notify-openclaw/compare/v0.8.0...v0.9.0) (2026-04-23)


### Features

* added config for releases ([b5ebc0d](https://github.com/Onyelaudochukwuka/opencode-notify-openclaw/commit/b5ebc0d3cb7fc8b161d83d85c7bc96c297dcd4aa))
...
* Update release workflow to use npm publish command ([485c5de](https://github.com/Onyelaudochukwuka/opencode-notify-openclaw/commit/485c5de1bd3d8e99184cca1a8d5aaf4cd13a3f88))
...
* Update release workflow permissions and npm publish command ([7442c78](https://github.com/Onyelaudochukwuka/opencode-notify-openclaw/commit/7442c781329f19fbb4e84598f592293bd6fa7b07))
